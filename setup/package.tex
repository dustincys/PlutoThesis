...
\setCJKfamilyfont{bfsong}{FandolSong}
...
\newcommand{\bfsong}{\CJKfamily{bfsong}}    % 宋体   (Windows自带simsun.ttf)
...
\newcommand{\edegreetwoline}[2][c]{\renewcommand{\arraystretch}{1}\begin{tabular}[#1]{@{}l@{}}#2\end{tabular} \renewcommand{\arraystretch}{1.3} }
